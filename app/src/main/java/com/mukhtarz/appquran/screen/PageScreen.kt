                    ...
                    items(state.value){ index ->
                        Row(
                            modifier = Modifier
                                ...
                                .padding(10.dp)
                                .clickable {
                                    goToRead.invoke(null,null,index.page,null)
                                }
                        ) {
                            Box(
                                modifier = Modifier
                            ...
                            Column {
                                ...
                                Text(text = "Halaman ${index.page}", color = MaterialTheme.colorScheme.secondary)
                                Spacer(modifier = Modifier.height(10.dp))
                                Text(text = "${index.soraNameEmlaey} : ${index.ayaNo}", color = MaterialTheme.colorScheme.secondary)
                                Spacer(modifier = Modifier.height(6.dp))
                            }
